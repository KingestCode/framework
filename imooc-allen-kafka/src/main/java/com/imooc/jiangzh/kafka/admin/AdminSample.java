...
public class AdminSample {
    ...
    public final static String TOPIC_NAME="miaoqi-topic";
...
//        ConfigResource configResource = new ConfigResource(ConfigResource.Type.BROKER, TOPIC_NAME);
    ...
    public static void topicLists() throws Exception {
        AdminClient adminClient = adminClient();
        // 是否查看internal选项, kafka 内部的 topic
    ...
    public static AdminClient adminClient(){
        ...
        properties.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG,"192.168.2.100:9092");
